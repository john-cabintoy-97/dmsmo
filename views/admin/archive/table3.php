                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-evenly align-items-center">
                                <button onclick="restoreIn('<?= $lists->in_id; ?>')" class="btn btn-sm btn-warning text-white" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Restore Incoming"><i class="fas fa-undo"></i></button>
                                <button onclick="deleteIn(<?= $lists->in_id; ?>,<?= $_SESSION['dmsmo_users']; ?>)" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete Incoming"><i class="fa fa-trash"></i></button>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
