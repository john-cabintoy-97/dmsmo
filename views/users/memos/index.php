...
$page_title = PAGE_TITLE . " | DOCUMENTS";
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= URL ?>users">Memos</a></li>
            </ol>
        </div>
        <div class="row">
            <!-- column -->
                    ...
                    <div class="card-body">
                        <h4 class="card-title m-0 p-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="m-0 font-weight-bold">Memos</h5>
                                <button class="btn btn-re" data-bs-toggle="modal" data-bs-target="#infileModal"><i class="fa fa-plus-square"></i>&nbsp;SHARE DOCUMENTS</button>
                            </div>
                        </h4>
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="container1-tab" data-bs-toggle="tab" data-bs-target="#container1" type="button" role="tab" aria-controls="container1" aria-selected="true">Outgoing Memo</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="container2-tab" data-bs-toggle="tab" data-bs-target="#container2" type="button" role="tab" aria-controls="container2" aria-selected="false">History</button>
                            </li>
                        </ul>
                                ...
                                <div class="table-responsive">
                                    <table id="common_table" class="table table-bordered" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <?php if ($_SESSION['dmsmo_users'] === $lists->users_id) : ?>
                                                    <tr>
                                                        <td><?= $counter++; ?></td>
                                ...
                                <div class="table-responsive">
                                    <table id="other_table" class="table table-bordered" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <?php if ($lists->shared_by == $_SESSION['dmsmo_users']) : ?>
                                                    <tr>
                                                        <td><?= $counter++; ?></td>
                                                        <td><?= strtoupper($lists->control_no); ?></td>
                                                        <td><?= strtoupper($getFile->filename) . '.' . strtolower($getFile->filetype) . ' / ' . $controller->convertBytes($getFile->filesize); ?></td>
