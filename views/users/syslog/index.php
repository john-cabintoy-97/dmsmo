...
$page_title = PAGE_TITLE . " | SYSTEM LOG";
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= URL ?>users">Account Logs</a></li>
            </ol>
        </div>
        <div class="row">
            <!-- column -->
                    ...
                    <div class="card-body">
                        <h4 class="card-title m-0 p-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="m-0 font-weight-bold">System Logs</h5>
                            </div>
                        </h4>
                        <div class="table-responsive">
                            <table id="common_table" class="table table-bordered" width="100%">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <?php if ($data->user_type !== 'administrator' && $lists->users_id == $_SESSION['dmsmo_users']) : ?>
                                            <tr>
                                                <td><?= $counter++; ?></td>
                                                <td><?= $lists->ip; ?></td>
                                                <td><?= $lists->host; ?></td>
